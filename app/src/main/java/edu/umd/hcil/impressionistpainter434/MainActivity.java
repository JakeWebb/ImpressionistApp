...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener, SensorEventListener {
    ...
    public void onButtonClickSave(View v) {
        ...
        Bitmap drawing  =_impressionistView.getDrawing();
        MediaStore.Images.Media.insertImage(getContentResolver(), drawing, null, null);
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuLine:
                ...
                return true;
            case R.id.menuGravBrush:
                Toast.makeText(this, "Gravity Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.GravBrush);
                return true;
        }
        return false;
    }
...
//        System.out.println(aY);
        ...
        _impressionistView.gravBrush(aX,aY);
    }
